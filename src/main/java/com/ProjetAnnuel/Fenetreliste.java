...
//Importation des diff�rentes fonctionnalit�s Swing et des donn�es des autres .java
...
public class Fenetreliste extends javax.swing.JInternalFrame {
	...
	void load() {
		/**
		 * Liste tous les candidats de la base de doon�es
		 */
				...
				.addGroup(jPanel2Layout.createSequentialGroup()
					...
					.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
							.addComponent(lblProposition, GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
	...
	//D�claration des diff�rents composants
